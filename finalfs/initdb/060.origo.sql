...
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('edit:edit_id','<b>Ändring > Id</b><br>Ett löpnummer som identifierar den enskilda ändringen.') ON CONFLICT DO NOTHING;
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('edit:target_key','<b>Ändring > Objektnyckel</b><br>Den stabila nyckel (typ:id) som knyter ändringen till ett specifikt objekt.') ON CONFLICT DO NOTHING;
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('edit:target_table','<b>Ändring > Tabell</b><br>Vilken konfigurationstabell objektet lagras i.') ON CONFLICT DO NOTHING;
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('edit:target_id','<b>Ändring > Objekt-id</b><br>Objektets id vid ändringstillfället.') ON CONFLICT DO NOTHING;
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('edit:date','<b>Ändring > Datum</b><br>Tidpunkten då ändringen sparades.') ON CONFLICT DO NOTHING;
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('edit:action','<b>Ändring > Åtgärd</b><br>Vilken typ av åtgärd som loggades, t ex "update".') ON CONFLICT DO NOTHING;
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('edit:changed_by','<b>Ändring > Ändrad av</b><br>Vem som gjorde ändringen, om detta har registrerats.') ON CONFLICT DO NOTHING;
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('edit:abstract','<b>Ändring > Beskrivning</b><br>En valfri, läsbar förklaring av vad ändringen innebar. Kan fyllas i av en administratör i efterhand.') ON CONFLICT DO NOTHING;
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('edit:before_data','<b>Ändring > Tillstånd före</b><br>Objektets konfiguration (JSON) innan ändringen genomfördes. Används av "Backa"-knappen.') ON CONFLICT DO NOTHING;
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('edit:after_data','<b>Ändring > Tillstånd efter</b><br>Objektets konfiguration (JSON) efter att ändringen genomfördes. Används av "Gör om"-knappen.') ON CONFLICT DO NOTHING;
INSERT INTO map_configs.helps(help_id,abstract) VALUES ('edit:info','<b>Ändring > Info</b><br>Fält för administrativ information om ändringen.') ON CONFLICT DO NOTHING;
